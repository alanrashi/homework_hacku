			...
			<div class="container-fluid">
                 <div class="row">
                        <div class="col list_product">                            
							...
							echo '<li><a href="#">', $item['list_name'],'</a></li>';
							};
							?>  
                            </ul>
                            <div class="list_name_product">
                            ...
                            <div class="card-columns"> 
									...
									foreach ($card_items['items'] as $items) {
                                        echo  '<div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <a href="product_page.html" class="product__title">', $items['prod_name'],'</a>
                                                        <div>
                                                        ...
                                                        <a href="product_page.html" class="btn btn-primary">В КОРЗИНУ</a>
                                                        <a href="product_page.html" class="link_fastbuy">
